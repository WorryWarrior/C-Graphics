...
TestComponent::TestComponent(Game* inGame)
{
    game = inGame;
}
...
bool TestComponent::TryCompileAndCreateVertexShader()
{
...
bool TestComponent::TryCompileAndCreatePixelShader()
{
...
void TestComponent::CreateLayout()
{
...
void TestComponent::CreateBuffers()
{
...
void TestComponent::DestroyResources()
{
