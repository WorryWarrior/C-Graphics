...
namespace DirectX
{
    namespace SimpleMath
    {
        ...
        struct Rectangle
        {
            ...
            explicit Rectangle(const RECT& rct) noexcept : x(rct.left), y(rct.top), width(rct.right - rct.left),
            ...
            {
                return (x <= r.x) && ((r.x + r.width) <= (x + width)) && (y <= r.y) && ((r.y + r.height) <= (y +
                    height));
            }
        ...
        struct Vector2 : public XMFLOAT2
        {
            ...
            static Vector2 Barycentric(const Vector2& v1, const Vector2& v2, const Vector2& v3, float f,
                                       float g) noexcept;
        ...
        struct Vector3 : public XMFLOAT3
        {
            ...
            static Vector3 Barycentric(const Vector3& v1, const Vector3& v2, const Vector3& v3, float f,
                                       float g) noexcept;
        ...
        struct Vector4 : public XMFLOAT4
        {
            ...
            static Vector4 Barycentric(const Vector4& v1, const Vector4& v2, const Vector4& v3, float f,
                                       float g) noexcept;
